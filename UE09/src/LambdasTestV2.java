...
public class LambdasTestV2 {
    ...
    void testPrintWithStrings() {
        ...
        assertEquals("A"+System.lineSeparator()+"B"+
                System.lineSeparator()+"C"+System.lineSeparator(), output);
    }
    ...
    void testPrintWithNullElements() {
        ...
        String output = captureOutput(() -> Lambdas.print(collection));
        assertEquals("A"+System.lineSeparator()+"null"+
                System.lineSeparator()+"B"+System.lineSeparator(), output);
    }
    ...
    void testPrintWithMixedTypes() {
        ...
        String output = captureOutput(() -> Lambdas.print(collection));
        assertEquals("String"+System.lineSeparator()+"42"+
                System.lineSeparator()+"3.14"+System.lineSeparator()+"true"+
    ...
    void testPrintWithLargeCollection() {
        ...
        assertEquals("0"+System.lineSeparator()+"1"+
                ...
                System.lineSeparator()+"4"+System.lineSeparator(), output);
    }
