...
import java.util.*;
import MySubnetComparator_1_2.MySubnetComparator;
import MySubnetComparator_1_2.MySubnetComparator2;
...
class IpCollectionTestv2 {
    ...
    void ipAddressTest1() {
        ...
        Assertions.assertEquals(new IPAddress("10.0.0.1"), new IPAddress("10.0.0.1"), __msg);
    }

    @Test
    void ipAddressTest2() {
        String __msg = "wurde hashCode() definiert?";
        Assertions.assertEquals(new IPAddress("10.0.0.1").hashCode(), new IPAddress("10.0.0.1").hashCode(),
                __msg);
    }
    ...
    void ipAddressTest3() {
        ...
        sIP.add(new IPAddress("10.0.0.1"));
        Assertions.assertEquals(2, sIP.size(), __msg);
    }
    ...
    void ipAddressTest7() {
        ...
        Assertions.assertEquals(new IPAddress("172.16.0.1"),
                st.toArray()[1]
                , __msg);
    }
    ...
    void snMySnComparatorTest1() {
        ...
        Assertions.assertTrue(mc.compare(sn1, sn2) < 0, __msg);
        __msg = "mc.compare(sn2, sn1) > 0";
        Assertions.assertTrue(mc.compare(sn2, sn1) > 0, __msg);
        __msg = "mc.compare(sn1, sn3) > 0";
        Assertions.assertTrue(mc.compare(sn1, sn3) > 0, __msg);
        __msg = "mc.compare(sn3, sn1) < 0";
        Assertions.assertTrue(mc.compare(sn3, sn1) < 0, __msg);
    }
    ...
    void snMySnComparatorTest3() {
        ...
        Assertions.assertEquals(0x7f000000,
                ((Subnet)(next.keySet().toArray()[0])).getNet().getIP()
                , __msg);
        __msg = "Treemap 2. Element";
        Assertions.assertEquals(0xac100000,
    ...
    void snMySnComparator2Test1() {
        ...
        Assertions.assertTrue(mc.compare(sn4, sn3) < 0, __msg);
    }
    ...
    void getNextHopTest1() {
        ...
        Assertions.assertNull(ip.getNextHop(next));
    }
    ...
    void getNextHopTest2() {
        ...
        next.put(new Subnet("192.168.0.0/23"), new IPAddress("192.168.1.250"));
        next.put(new Subnet("127.0.0.0/8"), new IPAddress("192.168.1.249"));
        Assertions.assertEquals(new IPAddress("192.168.1.252") , ip.getNextHop(next));
    }
    ...
    void getNextHopTest3() {
        ...
        next.put(new Subnet("192.168.0.0/23"), new IPAddress("192.168.1.250"));
        next.put(new Subnet("127.0.0.0/8"), new IPAddress("192.168.1.249"));
        Assertions.assertEquals(new IPAddress("192.168.1.251") , ip.getNextHop(next));
    }
    ...
    void getNextHopTest4() {
        ...
        next.put(new Subnet("192.168.0.0/23"), new IPAddress("192.168.1.250"));
        next.put(new Subnet("127.0.0.0/8"), new IPAddress("192.168.1.249"));
        Assertions.assertEquals(new IPAddress("192.168.1.249") , ip.getNextHop(next));
    }
    ...
    void getNextHopTest5() {
        ...
        next.put(new Subnet("192.168.0.0/23"), new IPAddress("192.168.1.250"));
        next.put(new Subnet("127.0.0.0/8"), new IPAddress("192.168.1.249"));
        Assertions.assertEquals(new IPAddress("192.168.1.254") , ip.getNextHop(next));
    }
    ...
    void getNextHopTest6() {
        ...
        next.put(new Subnet("192.168.0.0/23"), new IPAddress("192.168.1.250"));
        next.put(new Subnet("127.0.0.0/8"), new IPAddress("192.168.1.249"));
        Assertions.assertEquals(new IPAddress("192.168.1.250") , ip.getNextHop(next));
    }
    ...
    void getNextHopTest8() {
        ...
        next.put(new Subnet("192.168.0.0/23"), new IPAddress("192.168.1.250"));
        next.put(new Subnet("127.0.0.0/8"), new IPAddress("192.168.1.249"));
        Assertions.assertEquals(new IPAddress("192.168.1.253") , ip.getNextHop(next));
    }
}